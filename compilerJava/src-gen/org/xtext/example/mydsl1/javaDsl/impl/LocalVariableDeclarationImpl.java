 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.javaDsl.impl.LocalVariableDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.javaDsl.impl.LocalVariableDeclarationImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalVariableDeclarationImpl extends BlockStatementImpl implements LocalVariableDeclaration
{
  ...
  {
    return JavaDslPackage.Literals.LOCAL_VARIABLE_DECLARATION;
  }
  ...
  public EList<VariableDeclarator> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentEList<VariableDeclarator>(VariableDeclarator.class, this, JavaDslPackage.LOCAL_VARIABLE_DECLARATION__VARIABLES);
    }
    return variables;
  }
